                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($query as $row) {
                                            ...
                                            echo "<td>
                                                <a href='edit_kelurahan.php?id=" . $row['id'] . "'><button class='btn btn-info'>Edit</button></a>
                                                <a href='delete_kelurahan.php?id=" . $row['id'] . "'><button class='btn btn-danger'>Delete</button></a>
