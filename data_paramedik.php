                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($query as $row) {
                                            ...
                                            echo "<td>
                                                <a href='edit_paramedik.php?id=" . $row['id'] . "'><button class='btn btn-info'>Edit</button></a>
                                                <a href='hapus_paramedik.php?id=" . $row['id'] . "'><button class='btn btn-danger'>Delete</button></a>
